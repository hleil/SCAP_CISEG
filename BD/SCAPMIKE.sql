...
INSERT INTO `REGLOGIN` VALUES (1,'2018-12-17 08:19:45',2),(2,'2018-12-17 08:24:13',3),(3,'2018-12-17 08:26:24',4);
...
INSERT INTO `TAACTIVOSCAP` VALUES (1,'SABER','2019-01-01','2019-02-01','CIC IPN','Evaluación anual 2018','3','2018-12-17 08:20:46',NULL,2,1);
...
INSERT INTO `TACASOPRUEBACONFSCAP` VALUES (1,'Configuración del sistema de archivos','Asegurar que el montaje de los sistemas de archivos cramfs esté deshabilitado','Verificar que el sistema operativo no tuviera montado el sistema de archivos cramfs.','$ modprobe -n -v cramfs\r\n$ lsmod | grep cramfs\r\n','','Los comandos no arrojaron alguna salida en consola, por lo cual el formato  cramfs está deshabilitado','','','Correcto',0,NULL,'2018-12-17 08:22:07','2018-12-17 08:26:08',5,1),(2,'Configuración del sistema de archivos','Asegurar que el montaje de los sistemas de archivos cramfs esté deshabilitado','Verificar que el sistema operativo no tuviera montado el sistema de archivos cramfs.','$ modprobe -n -v cramfs\r\n$ lsmod | grep cramfs\r\n','Ninguno','Al no tener ningún resultado en consola, el formato  cramfs está deshabilitado','','','Correcto',0,NULL,'2018-12-17 08:22:07','2018-12-17 08:26:52',5,1),(3,'Configuración del sistema de archivos','Asegurar que el montaje de los sistemas de archivos FAT esté deshabilitado','Verificar que el sistema operativo no tuviera montado el sistema de archivos fat.',NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,'2018-12-17 08:22:24',NULL,1,1),(4,'Configuración del sistema de archivos','Asegurar que el montaje de los sistemas de archivos FAT esté deshabilitado','Verificar que el sistema operativo no tuviera montado el sistema de archivos fat.',NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,'2018-12-17 08:22:24',NULL,1,1),(5,'Configuración del nivel del sistema operativo','Cuenta con privilegios mínimos dedicados','Verificar que el usuario para el sistema del SABER no tenga privilegios de administración sobre el gestor de la base de datos',NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,'2018-12-17 08:22:53',NULL,1,2),(6,'Configuración del nivel del sistema operativo','Cuenta con privilegios mínimos dedicados','Verificar que el usuario para el sistema del SABER no tenga privilegios de administración sobre el gestor de la base de datos',NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,'2018-12-17 08:22:53',NULL,1,2),(7,'Configuración del nivel del sistema operativo','Historial de comandos de MySQL','Verificar que no exista el archivo que guarda el historial de las sentencias ejecutadas en el gestor de la base de datos',NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,'2018-12-17 08:23:07',NULL,1,2),(8,'Configuración del nivel del sistema operativo','Historial de comandos de MySQL','Verificar que no exista el archivo que guarda el historial de las sentencias ejecutadas en el gestor de la base de datos',NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,'2018-12-17 08:23:07',NULL,1,2);
...
INSERT INTO `TAPRUEBASCAP` VALUES (1,'2019-01-01','2019-02-01','2018-12-17 08:20:46',NULL,2,1,1,1);
...
INSERT INTO `TAUSRCONFSCAP` VALUES (3,1),(3,3),(3,5),(3,7),(4,2),(4,4),(4,6),(4,8);
...
INSERT INTO `TAUSRSCAP` VALUES (1,'Administrador','admin@admin.com','f7ca99e01b352fe0497674bde192879da301c5168074f1e933e6c81ff2dbc05e',0,'2018-12-17 08:18:22',NULL,1,1),(2,'Eleazar Aguirre Anaya','eaguirre@cic.ipn.mx','4f7e5d0e0accdf1498c6677403bbe8eceb02135f2c3a68ceef18ca8292abb8cb',0,'2018-12-17 08:18:22',NULL,2,1),(3,'Miguel Hernández Hernández','hegumi@hotmail.com','4f7e5d0e0accdf1498c6677403bbe8eceb02135f2c3a68ceef18ca8292abb8cb',0,'2018-12-17 08:18:22',NULL,3,1),(4,'Byron González Flores','byronemail7@gmail.com','4f7e5d0e0accdf1498c6677403bbe8eceb02135f2c3a68ceef18ca8292abb8cb',0,'2018-12-17 08:18:22',NULL,3,1),(5,'Luis Macedo Santiago','lumacs13@gmail.com','3772b212b455938bd052e58e11963a78fd0d2173005c9b69a18ebb571fcf2c4f',1,'2018-12-17 08:18:22',NULL,3,1),(6,'Armando Díaz Peláez','c.armando.diaz.p@gmail.com','3772b212b455938bd052e58e11963a78fd0d2173005c9b69a18ebb571fcf2c4f',1,'2018-12-17 08:18:22',NULL,3,1),(7,'Ivan Sánchez','isc.ivan.sanchez@gmail.com','4f7e5d0e0accdf1498c6677403bbe8eceb02135f2c3a68ceef18ca8292abb8cb',0,'2018-12-17 08:18:22',NULL,4,1),(8,'Antonio Ocampo','fenix@engineer.com','3772b212b455938bd052e58e11963a78fd0d2173005c9b69a18ebb571fcf2c4f',1,'2018-12-17 08:18:22',NULL,4,1);
...
-- Dump completed on 2018-12-17  8:27:48
