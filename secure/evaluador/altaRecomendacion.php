            ...
            <div class="flex-row">
                ...
                <div class="content col-1 light-gray-bg">
                    <div class="content-widget white-bg">
                        <h2 class="margin-bottom-10">Iniciar evaluación</h2>
                        ...
                        <form class="login-form" method="post" action="../../controlador/controlador.php">
                            ...
                            <div class="form-group text-right">
                                ...
                                <button type="submit" class="blue-button" name="registrarEval" id="registrarEval">Guardar</button>
                            </div>  
                        </form>
                        </div>
