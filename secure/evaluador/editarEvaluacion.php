                        ...
                        <form class="login-form" method="post" action="../../controlador/controlador.php">
                            ...
                            <div class="row form-group">
                                <div class="col-lg-12 col-md-6 form-group">                  
                                    ...
                                    <textarea class="form-control"  name="entrada" id="entrada" rows="4" cols="50" maxlength="200" required><?PHP echo $_SESSION["entrada"];?></textarea>
                                </div>
                                <div class="col-lg-12 col-md-6 form-group">                  
                                    <label for="inputFirstName">Resultado</label>
                                    <textarea class="form-control"  name="resultado" id="resultado" rows="4" cols="50" maxlength="200"><?PHP echo $_SESSION["resultado"];?></textarea>
                                </div>
                                <div class="col-lg-12 col-md-6 form-group">                  
                                    <label for="inputFirstName">Información complementaria</label>
                                    <textarea class="form-control"  name="infComp" id="infComp" rows="4" cols="50" maxlength="200" required><?PHP echo $_SESSION["informacionComplementaria"];?></textarea>
                                </div>
                                <div class="col-lg-12 col-md-6 form-group">                  
                                    <label for="inputFirstName">Evidencias</label>
                                    <textarea class="form-control"  name="evidencias" id="evidencias" rows="4" cols="50" maxlength="200" ><?PHP echo $_SESSION["evidencias"];?></textarea>
                                </div>
                                <div class="col-lg-12 col-md-6 form-group">                  
                                    <label for="inputFirstName">Recomendación</label>
                                    <textarea class="form-control"  name="recomendacion" id="recomendacion" rows="4" cols="50" maxlength="200" ><?PHP echo $_SESSION["recomendacion"];?></textarea>
                                </div>
                                <div class="col-lg-12 col-md-6 form-group">                  
                                    <label for="inputFirstName">Comentario de validador</label>
                                    <textarea class="form-control"  name="comentarioVal" id="comentarioVal" rows="4" cols="50" maxlength="200" readonly><?PHP echo $_SESSION["comentariosValidador"];?></textarea>
                                </div>
                                <div class="col-lg-12 col-md-6 form-group">                  
                            ...
                            <div class="form-group text-right">
                                ...
                                <button type="submit" class="blue-button" name="modificarResultado" id="modificarResultado">Evaluar</button>
                            </div>  
                        </form>
                    </div>
