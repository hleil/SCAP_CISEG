        ...
        <head>
            ...
            <script type="text/javascript">
                ...
                function changeValuer2(){
                    document.getElementById("opcionValue").value = "3";
                }
            </script>
            ...
            <div class="flex-row">
                ...
                <div class="content col-1 light-gray-bg">
                    ...
                    <div class="content-widget white-bg">
                        <h2 class="margin-bottom-10">Consultar activos</h2>
                                    ...
                                    <table class="table table-striped table-bordered user-table">
                                        <thead>
                                            <tr>
                                                ...
                                                <td><a href="" class="white-text sort-by">Nombre </a></td>
