            ...
            <div class="flex-row">
                ...
                <div class="content col-1 light-gray-bg">
                    ...
                    <div class="col-1">    
                        ...
                        if (isset($_SESSION["ErrorModificarActivo"])) {
                            echo "<div class='content-widget pink-bg'>";
                            echo "<h2 class='text-uppercase margin-bottom-10'>Error al modificar el activo</h2>";
                            echo "<p class='margin-bottom-0'>No se pudieron guardar los nuevos datos.</p>";
                            echo "</div>";
                            unset($_SESSION["ErrorModificarActivo"]);
                        }
                        ?>
                    ...
                    <div class="content-widget white-bg">
                        <h2 class="margin-bottom-10">Modificar activo</h2>
                        <form class="login-form" method="post" action="../../controlador/controlador.php">
                            ...
                            <div class="row form-group">
                                <div class="col-lg-6 col-md-6 form-group">                  
                                    ...
                                    <input type="date" class="form-control" id="fInicio" name="fInicio" min="2018-12-01" max="2030-12-31" value="<?PHP echo $fInicio;?>" required>
                                   <br><br>                  
                                </div>

                                <div class="col-lg-6 col-md-6 form-group">
                                    <label for="inputUsername">Fecha de conclusión</label>
                                    <input type="date" class="form-control" id="fFin" name="fFin" min="2018-12-01" max="2030-12-31" value="<?PHP echo $fFin;?>"  required>
                                    <br><br>
                        ...
                        <div class="row form-group">
                            <div class="col-lg-2 col-md-2 form-group">                  
                                ...
                                <button name='modificarActivo' id='modificarActivo' class="blue-button">Guardar</button>          
                                </form>
                            </div>
                            <div class="col-lg-2 col-md-2 form-group">                  
