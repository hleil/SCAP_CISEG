...
$tipoPrueba = $_SESSION["idTipoPrueba"];
            ...
            <div class="flex-row">
                ...
                <div class="content col-1 light-gray-bg">
                    ...
                    <div class="content-widget white-bg">
                        <h2 class="margin-bottom-10">Consultar Pruebas de Activo</h2>
                            ...
                            <div class="content-widget no-padding">
                                <div class="panel panel-default table-responsive">
                                    <table class="table table-striped table-bordered user-table">
                                        ...
                                        <?php
                                            #echo 'Tipo Prueba '.$tipoPrueba;
                                            $objModelo->listarCasosDePrueba($idUsuario, $idActivo, $tipoPrueba);   
                                        ?> 
